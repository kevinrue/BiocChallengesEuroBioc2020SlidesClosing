...
- GitHub template repository for other thematic challenges.

- `r BiocStyle::Githubpkg("kevinrue/BiocChallenges")` itself is an R package, proving functions to manage challenges.
  Other challenge packages can declare `Imports:` to use those functions.
]
